# ITAI1378_SkinLesionClassifier
Midterm - Computer vision project: Skin lesion classifier (benign vs malignant) using PyTorch and transfer learning
...
Day 1: Get the dataset and set up the environment → Dataset ready 
Day 2:Train or fine-tune the model → Model working 
Day 3: Test the model and improve results → Good accuracy 
Day 4: Evaluate results and make improvements → Improved performance 
Day 5: Final testing and documentation → Project complete 
Day 6: Final review and submit project → Project submitted 
...
ChatGPT was used to verify terminology and get a plain language explanation of technical concepts when needed.   
